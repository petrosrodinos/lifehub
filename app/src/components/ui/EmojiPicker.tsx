      ...
      {showCustomInput && (
        <div className="flex flex-col gap-2 mt-2 sm:flex-row sm:items-center sm:gap-3">
          <input
            ...
            className="w-full min-w-0 flex-1 px-3 py-2 bg-slate-800 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50 text-center text-xl"
            disabled={disabled}
            maxLength={4}
            autoFocus
          />
          <div className="flex flex-wrap gap-2 sm:flex-nowrap">
            <button
              ...
              className="px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium whitespace-nowrap"
            >
              Use
            </button>
            <button
              ...
              disabled={disabled}
              className="px-3 py-2 bg-slate-700 hover:bg-slate-600 text-slate-200 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm whitespace-nowrap"
            >
              Cancel
            </button>
          </div>
