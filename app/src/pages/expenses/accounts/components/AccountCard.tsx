  ...
  return (
    <>
      <button
        ...
        className="w-full text-left bg-slate-900/40 hover:bg-slate-900/60 border border-slate-800/50 hover:border-violet-500/40 rounded-lg p-3 transition-all duration-200"
      >
        ...
        <p className={`text-lg font-semibold ${balance.isNegative ? 'text-red-400' : 'text-emerald-400'}`}>
          {balance.formatted}
        </p>
      </button>
