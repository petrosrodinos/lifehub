    ...
    <>
      ...
      >
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-slate-800/50 rounded-lg shrink-0">
            {getTypeIcon()}
          </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="mb-1">
              <p className="text-xs sm:text-sm font-medium text-white truncate">
                {transaction.subcategory?.name || transaction.category?.name || 'Transaction'}
              </p>
            </div>
          ...
          <div className={`text-sm sm:text-base font-semibold ${getTypeColor()} shrink-0`}>
            {getAmountDisplay()}
          </div>
        </div>
      </button>
