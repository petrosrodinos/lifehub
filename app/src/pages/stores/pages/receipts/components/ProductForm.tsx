...
} from "../../../../../features/expenses/expense-products/interfaces/expense-products.interfaces"
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="space-y-2">
        ...
        <input
          ...
          placeholder="e.g., Whole Milk, Olive Oil"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-3 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-transparent transition-all"
            disabled={isPending}
          />
        </div>
