...
export function ReceiptManualTab({
  expenseEntryUuid,
  storeUuid,
  receiptDate,
  totalAmount,
  ...
  isEntryDisabled,
  submitLabel,
  onExpenseEntryChange,
  onStoreChange,
  onDateChange,
  onAmountChange,
  onSubmit,
  onCancel,
}: ReceiptManualTabProps) {
    ...
    <form onSubmit={onSubmit} className="space-y-5">
      <div className="space-y-2">
        ...
        <select
          ...
          onChange={(e) => onExpenseEntryChange(e.target.value)}
          ...
          disabled={isPending || isEntryDisabled}
          required
        >
