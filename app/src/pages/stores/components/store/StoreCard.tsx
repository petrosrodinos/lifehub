    ...
    <>
      <div className="w-full text-left bg-slate-900/40 hover:bg-slate-900/60 border border-slate-800/50 hover:border-violet-500/40 rounded-lg p-3 transition-all duration-200 group">
        <div className="flex items-center gap-3">
          ...
          <button type="button" onClick={handleEditClick} className="p-1.5 text-slate-400 hover:text-violet-400 hover:bg-violet-500/10 rounded-lg transition-colors opacity-0 group-hover:opacity-100 shrink-0">
