...
export function DeleteReceiptModal({ isOpen, onClose, onSuccess, receipt }: DeleteReceiptModalProps) {
  ...
  return <ConfirmationModal isOpen={isOpen} onClose={onClose} onConfirm={handleConfirm} title="Delete Receipt" description={`Are you sure you want to delete this receipt? All associated items will also be deleted. This action cannot be undone.`} confirmText="Delete" cancelText="Cancel" variant="danger" isPending={deleteReceipt.isPending} />;
}
