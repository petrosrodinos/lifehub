...
export function ActivitiesMenu({ isOpen, onClose }: ActivitiesMenuProps) {
  ...
  return (
    <>
      ...
      <ConfirmationModal isOpen={!!deletingUuid} onClose={() => setDeletingUuid(null)} onConfirm={handleDeleteConfirm} title="Delete Activity" description={`Are you sure you want to delete "${deletingActivity?.name}"? This action cannot be undone and will remove all associated schedule slots.`} confirmText="Delete" cancelText="Cancel" variant="danger" isPending={deleteActivity.isPending} />
    </>
  );
}
